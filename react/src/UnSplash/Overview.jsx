...
function Overview() {
    return (
        <div className="overview">
            ...
            <p className="description">
                To access and utilize the Unsplash API, you'll first need to <a href="https://unsplash.com/join" className="link">register</a> if you do not have a pre-existing account or <a href="https://unsplash.com/login" className="link">login</a> if you already have an account. Once you're in, visit <a href="#" className="link">your apps</a>. Then click on "New application" and fill in the required fields to get started.<br />
                To start, your application operates in demo mode, capped at 50 requests per hour—ideal for testing, educational use, and demo apps. Transition to production mode by following the "Apply for Production" guidelines. Upon approval, your rate limit will be raised to its full capacity. Applications have specific <a href="https://help.unsplash.com/en/articles/2511245-unsplash-api-guidelines" className="link">guidelines</a> which include <a href="https://help.unsplash.com/en/articles/2511315-guideline-attribution" className="link">properly providing attribution for the photographer and Unsplash</a>. 
                All applications must follow the <a href="https://help.unsplash.com/en/articles/2511245-unsplash-api-guidelines" className="link">API Guidelines</a> or contact the official <a href="https://help.unsplash.com/en/articles/3887917-when-should-i-apply-for-a-higher-rate-limit" className="link">API team.</a>
            </p>
            <br />
